...
class xcorr_test_opencl(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_0_0_win, 7, 0, 1, 3)
        for r in range(7, 8):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_win, 6, 0, 1, 3)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.clenabled_XCorrelate_0 = clenabled.clXCorrelate(1,1,0,0,False,2,8192,2,gr.sizeof_float,600,6)
...
def main(top_block_cls=xcorr_test_opencl, options=None):
